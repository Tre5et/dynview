		...
		dispatcher.register(CommandManager.literal("adaptiveview")
				...
				.then(CommandManager.literal("config")
						...
						.then(CommandManager.literal("broadcast_changes")
								.executes(configCommandHandler::broadcastChanges)
								.then(CommandManager.literal("none")
										.executes(configCommandHandler::broadcastChangesNone)
								)
								.then(CommandManager.literal("ops")
										.executes(configCommandHandler::broadcastChangesOps)
								)
								.then(CommandManager.literal("all")
										.executes(configCommandHandler::broadcastChangesAll)
								)
						)
						.then(CommandManager.literal("broadcast_lock")
								.executes(configCommandHandler::broadcastLock)
								.then(CommandManager.literal("none")
										.executes(configCommandHandler::broadcastLockNone)
								)
								.then(CommandManager.literal("ops")
										.executes(configCommandHandler::broadcastLockOps)
								)
								.then(CommandManager.literal("all")
										.executes(configCommandHandler::broadcastLockAll)
								)
						)
						.then(CommandManager.literal("rules")
								...
								.then(CommandManager.argument("index", IntegerArgumentType.integer(1, 100))
										...
										.then(CommandManager.literal("name")
												.executes(configCommandHandler::ruleName)
												.then(CommandManager.argument("name", StringArgumentType.greedyString())
														.executes(configCommandHandler::ruleSetName)
												)
												.then(CommandManager.literal("clear")
														.executes(configCommandHandler::ruleClearName)
												)
										)
